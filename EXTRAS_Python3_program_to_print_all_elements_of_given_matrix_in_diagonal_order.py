# Python3 program to print all elements of given matrix in diagonal order 
ROW = 5
COL = 4
    ...
    for line in range(1, (ROW + COL)) : 
        ...
        for j in range(0, count) : 
            print(matrix[min(ROW, line) - j - 1] 
                        [start_col + j], end = "\t")
            print("\033[31m Count/ROW/Line/start_col/j: %2d %2d %2d %2d %2d \033[0m" %(count,ROW,line,start_col,j), end="")
            #\33[31m
